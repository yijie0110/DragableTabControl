...
namespace DragableTabControl.Extensions
{
    public class TabRegionAdapter : RegionAdapterBase<TabablzControl>
    {
        ...
        public TabRegionAdapter(IRegionBehaviorFactory regionBehaviorFactory, IContainerProvider containerProvider) : base(regionBehaviorFactory)
        {
        ...
        public void RemoveItemFromRegion(object item, IRegion region)
        {
